...
# Writing convincing Phishing email
...
Firstly launch the virtual machine by clicking the green **Start Machine** button on the right; once loaded, click the following URL to open the GoPhish login page [https://10-82-185-39.reverse-proxy.cell-prod-eu-west-1c.vm.tryhackme.com:8443](https://10-82-185-39.reverse-proxy.cell-prod-eu-west-1c.vm.tryhackme.com:8443/)  or if you're connected to the TryHackMe VPN, you can to go [https://10.82.185.39](https://10.82.185.39/)  (if you receive an Nginx error, wait another 30 seconds and try again).  
...
URL: [http://10.82.185.39](http://10.82.185.39/)[](http://10.82.185.39/)
