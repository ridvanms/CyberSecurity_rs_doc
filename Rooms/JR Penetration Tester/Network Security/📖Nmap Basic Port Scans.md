...
```shell-session
pentester@TryHackMe$ sudo nmap -sS 10.10.120.180

Starting Nmap 7.60 ( https://nmap.org ) at 2021-08-30 09:53 BST
Nmap scan report for 10.10.120.180
...
```shell-session
pentester@TryHackMe$ sudo nmap -sU 10.10.127.180

Starting Nmap 7.60 ( https://nmap.org ) at 2021-08-30 09:54 BST
Nmap scan report for 10.10.127.180
...
- UDP port scan takes longer than TCP port scans. The -F flag was added to speed up the scan (scan 100 most common instead of 1000). We also added -v to get updates as the scan progresses.

# Fine-Tunning Scope and Performance
...
|---|---|
|TCP Connect Scan|`nmap -sT 10.10.17.229`|
|TCP SYN Scan|`sudo nmap -sS 10.10.17.229`|
|UDP Scan|`sudo nmap -sU 10.10.17.229`|
