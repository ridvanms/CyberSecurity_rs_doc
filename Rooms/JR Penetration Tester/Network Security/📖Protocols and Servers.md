...
```shell-session
pentester@TryHackMe$ telnet 10.10.34.245
Trying 10.10.34.245...
Connected to 10.10.34.245.
Escape character is '^]'.
Ubuntu 20.04.3 LTS
bento login: frank
Password: D2xc9CgD
 ...
 * Support:        https://ubuntu.com/advantage
  ...
  Memory usage: 15%               IPv4 address for ens33: 10.10.34.245
  Swap usage:   0%
...
1. First, we connect to port 80 using `telnet 10.10.34.245 80`.
...
```shell-session
pentester@TryHackMe$ telnet 10.10.34.245 80
Trying 10.10.34.245...
Connected to 10.10.34.245.
Escape character is '^]'.
...
```shell-session
pentester@TryHackMe$ telnet 10.10.34.245 21
Trying 10.10.34.245...
Connected to 10.10.34.245.
Escape character is '^]'.
220 (vsFTPd 3.0.3)
...
```shell-session
pentester@TryHackMe$ ftp 10.10.34.245
Connected to 10.10.34.245.
220 (vsFTPd 3.0.3)
Name: frank
331 Please specify the password.
...
```shell-session
pentester@TryHackMe$ telnet 10.10.34.245 25
Trying 10.10.34.245...
Connected to 10.10.34.245.
Escape character is '^]'.
...
```shell-session
pentester@TryHackMe$ telnet 10.10.34.245 110
Trying 10.10.34.245...
Connected to 10.10.34.245.
Escape character is '^]'.
+OK 10.10.34.245 Mail Server POP3 Wed, 15 Sep 2021 11:05:34 +0300 
USER frank
+OK frank
PASS D2xc9CgD
...
.
QUIT
+OK 10.10.34.245 closing connection
Connection closed by foreign host.
```
...
```shell-session
pentester@TryHackMe$ telnet 10.10.34.245 143
Trying 10.10.34.245...
Connected to 10.10.34.245.
Escape character is '^]'.
